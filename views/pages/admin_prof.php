  ...
  <div class="content-wrapper">
    ...
    $item=$prof[0];
     ...
     <div class="row">
       ...
       <a href="<?php echo base_url().'Account_admin_controller/active_p/'.$item['idprof'];?>" class="btn btn-success"><i class="fa fa-hand-o-right"></i> active account</a>
       <a href="<?php echo base_url().'Account_admin_controller/block_p/'.$item['idprof'];?>" class="btn btn-warning"><i class="fa fa-hand-stop-o"></i> block account</a>
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        <table class="table table-striped">
          ...
          <tr><th>id_student: </th><td><?php echo $item['idprof'];?></td></tr>
