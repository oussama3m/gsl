...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form action="<?php echo base_url(); ?>Register_controller/reg" method="post">
      ...
      <div class="form-group has-feedback">
        ...
        <label><input type="radio" name="genre" class="form-control" value="male" >female</label>
      </div>
      <div class="form-group has-feedback">
        <input type="date" name="date_naissance" class="form-control" placeholder="date_naissance: yyyy-mm-dd">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
